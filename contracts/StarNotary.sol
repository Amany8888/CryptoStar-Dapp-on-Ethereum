...
contract StarNotary is ERC721 {
    ...
    string public constant myTokenName = "Amany Token";
    string public constant sympol = "SRT";
    ...
    function buyStar(uint256 _tokenId) public  payable {
        ...
        // I think, i need to call transfer()
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerOf(_tokenId1)==msg.sender || ownerOf(_tokenId2)==msg.sender,"You can't exchange stars as you don't owne any one of them");
